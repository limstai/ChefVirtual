...
public class LoginFunBoundary extends Application {
	...
	private void background(Group root) {
		...
		Text titulo = new Text(480, 200, "LOGIN FUNCIONARIO");
	...
	private void botoes(Group root) {
		...
		btnEntrar.setStyle("-fx-background-color: blue;");
